...
public class ModelClient {
    ...
    public ModelClient(String address, int id, int clientsNums, int byzNums, String aggregator, String attackName, String _test){
        ...
        //    ServerSocket serverSocket = new ServerSocket(6100);
            ...
            // System.out.println("python3 ../../../../main/Client_bft.py " + Integer.toString(clientsNums) + " " + Integer.toString(id) + " " + address + " " + Integer.toString(port) + " " + Integer.toString(byzNums) + " " + aggregator + " " + attackName + " " + _test);
